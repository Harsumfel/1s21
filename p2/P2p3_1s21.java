...
public class P2p3_1s21 {
	public static void main(String[] args) {
		...
		System.out.println("ingrese un numero para la demostracion de su tabla de multiplicar del 0 al 10");
		String numero1="1";
		int numero2;
		numero1=teclado.nextLine();
		switch(numero1){
		case "0":
		    	System.out.println("tabla de multiplicar de 0");
		    ...
		    case "1":
			    ...
			    break;
			case "2":
		    	System.out.println("tabla de multiplicar de 2");
			    for ( numero2=0;numero2<=10;numero2++ ) {
			...
			case "3":
			    ...
			    break;
			case "4":
		    	System.out.println("tabla de multiplicar de 4");
			    for ( numero2=0;numero2<=10;numero2++ ) {
			...
			case "5":
			    ...
			    break;
			case "6":
		    	System.out.println("tabla de multiplicar de 6");
			    for ( numero2=0;numero2<=10;numero2++ ) {
			    System.out.println(6 + "*" + numero2 + "=" + 6 *numero2);}
			    break;
			case "7":
		    	System.out.println("tabla de multiplicar de 7");
			    for ( numero2=0;numero2<=10;numero2++ ) {
			    System.out.println(7 + "*" + numero2 + "=" + 7 *numero2);}
			    break;
			case "8":
		    	System.out.println("tabla de multiplicar de 8");
			    for ( numero2=0;numero2<=10;numero2++ ) {
			    System.out.println(8 + "*" + numero2 + "=" + 8 *numero2);}
			    break;
			case "9":
		    	System.out.println("tabla de multiplicar de 9");
			    for ( numero2=0;numero2<=10;numero2++ ) {
			    System.out.println(9 + "*" + numero2 + "=" + 9 *numero2);}
			    break;
			case "10":
		    	System.out.println("tabla de multiplicar de 10");
			    for ( numero2=0;numero2<=10;numero2++ ) {
